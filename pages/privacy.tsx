    ...
    <div className="content">
      <div>
        ...
        <ul>
          ...
          <p><strong>Information Regarding Your Data Protection Rights Under General Data Protection Regulation (GDPR)</strong></p>
          ...
          <ul>
            <li>You have given us permission to do so, for tracking your address balance</li>
          ...
          <p><strong>Protecting Your Child&apos;s Privacy</strong></p>
          ...
          <p><strong>Links to Third-Pary Websites</strong></p>
          ...
          <p><strong>Our Email Policy</strong></p>
